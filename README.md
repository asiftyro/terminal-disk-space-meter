...
disk_space_visual() {
    ...
    IFS=$'\n'
    # Get lines as array returned from df
    lines=($(df))
    ...
    for((i=0; i<${#lines[@]}; i++)); do
        ...
        if [[ $disk_type == *"/dev/"* ]];then
            ...
            # Get number of characters to be printed to show the meters red and green zone
            # Ceiling applied for red zone calculation
